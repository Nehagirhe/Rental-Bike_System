...
@WebServlet("/viewvinfo")
public class ViewVinfo extends HttpServlet {
...
//	</div>
	...
	try {
		ArrayList<VehicleUser> al1 = new UserDao().ViewAllVehicle();

		for(VehicleUser v1 : al1) {
			out.print("<a href='brandvehicle?id="+v1.getVbrand()+"' class='btn btn-primary'>"+v1.getVbrand()+"</a><\t>"); 
		}
		...
		for(VehicleUser v1 : al1) {
		       ...
		       // out.print("<button type='button' class='btn btn-dark' action='brandvehicle'>TVS</button>");
		      //  out.print("<p><a href='brandvehicle?id="+v1.getVbrand()+"' class='btn btn-primary'>"+v1.getVbrand()+"</a></p>");
		        out.print("</div>");
		        out.print("</div>");
		       // out.print("<br><br>");
		    }
